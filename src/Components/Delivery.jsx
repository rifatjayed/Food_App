...
const Delivery = () => {
    return (
        <div className='w-full bg-white py-16 px-4'>
            ...
            <div className=' w-[350px] md:w-[1240px] mx-auto grid md:grid-cols-2 '>
                <img className='object-cover 	 my-4 ' src="https://quickeat-react.vercel.app/assets/img/photo-1.png" alt="" />
                <div className='flex flex-col justify-center'>
                <p className='text-[#00df9a] font-bold '>Get The App</p>
                <h1 className=' md:text-4xl sm:text-3xl text-2xl font-bold py-2 text-center'>Limitless Convenience on-demand</h1>
                ...
                <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium mx-auto md:mx-0 my-6 '>Get Started</button>
            </div>
            </div>
