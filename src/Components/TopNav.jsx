                ...
                <nav>
                    <ul className='flex flex-col p-4 text-gray-900'>
                        <li className='text-xl py-4 flex'>
                            <BsPerson size={25} className='mr-4 text-white bg-black rounded-full'></BsPerson>
                            My Account
                        </li>
                        ...
                        <li className='text-xl py-4 flex'>
                            <MdOutlineFavorite size={25} className='mr-4 text-white bg-black rounded-full'></MdOutlineFavorite>
                            My Favourite
                        </li>
                        <li className='text-xl py-4 flex'>
